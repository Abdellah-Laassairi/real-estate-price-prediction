...
class RealModel(pl.LightningModule):
    def __init__(self,
        ...
        self.linear = torch.nn.Linear(self.num_target_classes, 1, bias=True)
    ...
    def training_step(self, batch, batch_nb):
        ...
        self.train_output_list.append((y, y_hat))
        return loss
