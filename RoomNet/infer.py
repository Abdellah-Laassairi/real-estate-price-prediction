...
INPUT_IMAGES_DIR = '/home/odeck/Desktop/data-challenge-2022/data/reduced_images/test/ann_11794173'
IMG_SIDE = 224

test_path ='../data/reduced_images/test/'
train_path='../data/reduced_images/train/'
...
if __name__ == '__main__':
    ...
    for sub in tqdm(test_subs):
        xl_out_path = classify_im_dir(nn, sub)
        k = 0
